...
$params=array(
	...
	'case'=>"nonlogin_wo_lampiran_ccd_eksternal_pdf",
	'batas'=>22,
	'halaman'=>1,
					...
					$cek_tujuan.='
						<tr>
							<td  width="17%" valign="top">
								<span style="border:1px solid #000;width:20px;height:20px;margin-bottom:2px;">&nbsp;<b>&radic;</b>&nbsp;</span>
							</td>
...
$html = '
	...
	<body>'.$headerHTML.'
		<div class="box1">
			...
			<table class="table3 table-unbordered table3-content" style="border:none;" width="100%">
											<tr>
												<td class="text-left" valign="bottom" style="border:none;" width="20%">
													
												</td>
												<td align="right">
													<table class="table2 table-bordered table2-content" width="100%">
														<tr>
															<td width="33%" align="center"><strong>Requested By</strong></td>
															<td width="33%" align="center"><strong>Acknowledge By</strong></td>
															<td width="34%" align="center"><strong>Approved By</strong></td>
														</tr>
			...
			<table class="tableTerima" width="100%" cellspacing="0" cellpadding="0">
				'.$terima_items.'
			</table>
			<br>
		</div>
