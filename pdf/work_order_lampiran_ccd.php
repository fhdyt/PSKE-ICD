	...
	$data_tujuan=array("Investasi","Perawatan/Modifikasi","Pergantian","Umum");
			...
			for($is=0;$is<$jlh_data_tujuan;$is++)
			{
				if($data_tujuan[$is]==$datawo[0]['WO_LAMPIRAN_TUJUAN'])
				{
					$cek_tujuan.='
						<tr>
							<td  width="17%" valign="top" style="padding:1px;">
								<img src="/asset/images/tick.png" width="10"/ style="border:none;">
							</td>
							<td width="83%" style="font-size: 15px;">'.$datawo[0]['WO_LAMPIRAN_TUJUAN'].'&nbsp;</td>
						</tr>';	
				...
				}else
				{
					$cek_tujuan.='								
								<tr>
									...
									<td width="83%" style="font-size: 15px;">'.$data_tujuan[$is].'&nbsp;</td>
								</tr>
								';
				}
				$NOBB++;
			...
			<table class="table3 table-unbordered table3-content" style="border:none;" width="100%">
				<tr>
					<td width="75%" valign="top">
						<table class="table3 table-unbordered table3-content" style="border:none;" width="100%">
							<tr>
								<td width="27%" valign="top" style="font-size: 15px;"><strong>Dept yang dituju</strong></td>
								<td width="1%" valign="top"><strong>: &nbsp;</strong></td>
								<td width="72%" valign="top" style="font-size: 15px;">
									'.$datawo[0]['COMPANY_UNIT_NAME_TO'].'
								</td>
							</tr>
							
							<tr>
								<td valign="top" style="font-size: 15px;"><strong>Fungsi WO</strong></td>
							...
							<tr>
								<td valign="top" style="font-size: 15px;"><strong>Dampak jika tidak dikerjakan</strong></td>
								<td valign="top"><strong>: &nbsp;</strong></td>
								<td valign="top" style="font-size: 15px;">
							...
							<tr>
								<td valign="top" style="font-size: 15px;"><strong>Kondisi saat ini</strong></td>
								<td valign="top"><strong>: &nbsp;</strong></td>
								<td valign="top" style="font-size: 15px;">
