...
foreach($result_a as $r){
	...
	*/
	...
	$this->MYSQL=new MYSQL();
	$this->MYSQL->database=$this->CONFIG->mysql_koneksi()->db_nama;
	$this->MYSQL->queri="select WO_DETAIL_INDEX,WO_DETAIL_ID,WO_DETAIL_DESCRIPTION, WO_DETAIL_QUANTITY,WO_UNIT_ID,WO_UNIT_NAME,WO_DETAIL_DATE_COMPLETED,WO_DETAIL_REMARK 
