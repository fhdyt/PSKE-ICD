		...
		if($record['VERIFIKASI_STATUS']=="Passed")
		{
			########################### 5. Kirim permintaan approve
					...
					$input_option_a=array(
							...
							'SISTEM_APPROVE_DOKUMEN_LINK'=>"?show=wo/html/transaction/work_order_lampiran_ccd/".$ck_wo[0]['WO_MASTER_ID']."/",//"?show=presensi/pdf/".$this->STORE_CONFIG->transaksi()->faktur_pdf_link_params[$input['STORE_INVOICE_TYPE']]."/".$ck[0]['STORE_INVOICE_INDEX']."/",
