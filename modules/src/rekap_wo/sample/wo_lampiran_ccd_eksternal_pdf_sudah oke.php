...
if(empty($result_wo_approve_tujuan))
{
	...
	$this->MYSQL->queri="select 
								...
								(CONFIG_APPROVE_DETAIL_SET_FOR='".$wo_items[0]['COMPANY_UNIT_ID_TO']."' or CONFIG_APPROVE_DETAIL_SET_FOR='all_unit') and
								 (COMPANY_STRUKTUR_ORGANISASI_JABATAN_NAME='Department Head' or COMPANY_STRUKTUR_ORGANISASI_JABATAN_NAME='General Manager') and
								 RECORD_STATUS='A'
								order by CONFIG_APPROVE_DETAIL_INDEX ASC LIMIT 2";
