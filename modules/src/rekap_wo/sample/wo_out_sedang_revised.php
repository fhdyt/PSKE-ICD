...
$this->MYSQL->queri="select * from WO_MASTER where WO_MASTER_ID='".$input['WO_MASTER_ID']."' and WO_MASTER_INDEX='".$input['WO_MASTER_INDEX']."'";	
...
foreach($result_a as $r){
	...
	*/
	...
	$this->MYSQL->database=$this->CONFIG->mysql_koneksi()->db_nama;
	$this->MYSQL->queri="select PERSONAL_NIK,PERSONAL_NAME from CONFIG_APPROVE_DETAIL 
		WHERE CONFIG_APPROVE_MASTER_APLIKASI_ID='wo' AND CONFIG_APPROVE_DETAIL_TYPE='in' AND CONFIG_APPROVE_DETAIL_SET_FOR='".$r['COMPANY_UNIT_ID_TO']."' AND RECORD_STATUS='A'";	
