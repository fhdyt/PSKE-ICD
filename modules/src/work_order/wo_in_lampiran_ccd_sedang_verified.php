...
$this->MYSQL->queri="select * from WO_MASTER a, WO_LAMPIRAN_CCD b where a.WO_MASTER_ID=b.WO_MASTER_ID and a.WO_MASTER_NOMOR=b.WO_MASTER_NOMOR and a.WO_MASTER_ID='".$input['WO_MASTER_ID']."' and a.WO_MASTER_INDEX='".$input['WO_MASTER_INDEX']."' and a.RECORD_STATUS='A' and b.RECORD_STATUS='A'";	
...
foreach($result_a as $r){
	...
	$this->MYSQL->queri="select PERSONAL_NIK,PERSONAL_NAME from CONFIG_APPROVE_DETAIL 
		WHERE CONFIG_APPROVE_MASTER_APLIKASI_ID='wo' AND COMPANY_UNIT_ID='".$r['COMPANY_UNIT_ID_TO']."' AND RECORD_STATUS='A' AND CONFIG_APPROVE_DETAIL_TYPE='in'";	
