...
foreach($result_a as $r){
	...
	*/
	...
	$this->MYSQL->queri="select PERSONAL_NIK,PERSONAL_NAME from CONFIG_APPROVE_DETAIL 
		WHERE CONFIG_APPROVE_MASTER_APLIKASI_ID='wo' AND CONFIG_APPROVE_DETAIL_SET_FOR='".$r['COMPANY_UNIT_ID']."' AND RECORD_STATUS='A' AND CONFIG_APPROVE_DETAIL_TYPE='out' order by CONFIG_APPROVE_DETAIL_ID ASC";	
