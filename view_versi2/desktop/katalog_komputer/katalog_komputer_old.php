			...
			<div class="modal-body">
				<form action="javascript:download();" class="fData form-group-sm" id="fData" name="fData">
					<div class="form-group">
						...
						<small class="help-block">Nomor Station ID</small>
					</div>
					<div class="form-group">
      ...
      $('#tujuan-light-pagination').pagination({
        ...
        currentPage: curPage,
	        ...
	        for (i = 0; i < data.result.length; i++)
	        {
	          ...
	          $("tbody#zone_data").append("<tr class='detailLogId'  ICD_STATION_ID='" + data.result[i].ICD_STATION_ID + "'>" +
	            "<td >" + data.result[i].NO + ".</td>" +
	            "<td>" + data.result[i].ICD_STATION_ID + "</td>" +
	             "<td>" + data.result[i].ICD_IP_ADDRESS + "</td>" +
	            "<td>" + data.result[i].PERSONAL_NAME + "</td>" +
	            "<td>" + data.result[i].COMPANY_UNIT_NAME + "</td>" +
