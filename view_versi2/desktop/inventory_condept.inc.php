		...
		<?php
		     //config breadcrumb halaman
		        $adminLTE->breadcrumb(array(
		            'title'=>"Inventory Control Department",
		            'title_sub'=>"1.0",
		            'breadcrumb'=>array(
			...
			<div class="row">
				<div class="col-md-12">
					...
					switch (strtoupper($d2)) {
					    case 'BARANG_INVENTORY':
					        require_once("barang_inventory/barang_inventory.php");
					        break;
              case 'APLIKASI_INVENTORY':
    					    require_once("aplikasi_inventory/aplikasi_inventory.php");
    					    break;
					    case 'INVENTORI':
					        require_once("inventori/inventori.php");
					        break;
					    case 'STATION_ID_DETAIL':
